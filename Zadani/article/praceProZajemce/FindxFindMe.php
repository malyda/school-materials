<ol>
	<li>
	FindX - program, který ukáže uživateli řadu míst (reprezentovanými např. O) a jedno z nich vybere jako místo, kam se ukryje X. Poté se všechna vyobrazená místa změní na X a uživatel je požádán o napsání poslední pozice X. <br>
	Hra funguje na principu levelování -> čím vyšší level tím více možností a kratší čas objevení X. <br>
	* Bonus na principu trénování krátkodobé paměti se po schování může X posunout o určitý počet pozic. Pro ukázku, kam se posune slouží obrázky např. <- 1.. doleva o 1 a při vyšších levelech obrázky  např. ☼ ‼.. doleva o 2
	<br>Ukázka bez bonusu <br><img src="images/findX.png"><br>
	</li>
	...
	Součástí odevzdání je: <br>
		<dd>samotný zdrojový kód</dd> <br> 
		<dd>uživatelská a technická dokumentace vč. všech formálních náležitostí týkajících se tvorby odborné práce</dd><br>
	...
	<li>
	Program, který generuje náhodné řetězce znaků a jeden hlavní. Na základě vstupu uživatele vypisuje, kolik znaků z tohoto vstupu je podobných s vybraným/hlavním řetězcem, či je vstup uživatele shodný s vybraným/hlavním řetězcem. <br>
